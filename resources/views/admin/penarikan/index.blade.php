...
<html lang="en">
          ...
          <div id="layoutSidenav_content">
              <main>
                  <div class="container-fluid">
                      <h1 class="mt-4">Penarikan Barang</h1>
                      ...
                      <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="button-group">
                                <button href="#add" class="btn btn-sm btn-success float-right trigger mr-2" data-title="Tambah Penarikan" data-mode="add" data-toggle="modal" data-target="#form-modal"><i class="fas fa-plus"></i> Tambah</button>
                                <a href="/penarikan/export/xls" class="btn btn-sm btn-success float-right mr-2"><i class="fas fa-file-excel"></i> Excel</a>
                                <a href="/penarikan/export/pdf" class="btn btn-sm btn-danger float-right mr-2"><i class="fas fa-file-pdf"></i> PDF</a>
                            </div>
                        </div>

                        @include('admin.templates.feedback')
                        @include('admin.penarikan.modal')
                        {{-- @include('admin.barang.detail') --}}
                        
                        <div class="card-body">
                            <div hidden id="data">{{$penarikan}}</div>
                            <div class="table-responsive">
                                <table class="table table-bordered" id="data-penarikan" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Kode Barang</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" disabled id="status" @if ($r->check()) checked @endif>
                                                ...
                                                <td>
                                                    <div class="btn-group">    
                                                        ...
                                                        <button href="#edit" data-id="{{$r->id}}" data-mode="edit" data-title="Edit Penarikan" class="btn btn-sm btn-warning mr-2 trigger" data-toggle="modal" data-target="#form-modal"><i class="far fa-edit"></i></button>
                                                        <form action="{{route('penarikan.index')}}" method="post" id="delete-form">
                                                            @csrf
                                                            @method('delete')
  ...
  <script>
    $(function(){
        ...
        // dataTable
        let table = $('#data-penarikan').DataTable({
            "paging" : true
        });

        let form = $('form.form-penarikan');
