...
<html lang="en">
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Kategori
                            <button href="#add" class="btn btn-sm btn-success float-right trigger" data-title="Tambah Kategori" data-mode="add" data-toggle="modal" data-target="#form-modal"><i class="fas fa-plus"></i> Tambah</button>
                        </div>
                        ...
                        <div class="card-body">
                            <div hidden id="data">{{$kategori}}</div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">    
                                                        ...
                                                        <button href="#edit" data-id="{{$r->id}}" data-mode="edit" data-title="Edit Kategori" class="btn btn-sm btn-warning mr-2 trigger" data-toggle="modal" data-target="#form-modal"><i class="far fa-edit"></i></button>
                                                        <form action="{{route('kategori.index')}}" method="post" id="delete-form">
                                                            @csrf
                                                            @method('delete')
  ...
  <script>
    $(function(){
        ...
        // dataTable
        let table = $('#data-kategori').DataTable({
            "paging" : true
        });

        let form = $('form.form-kategori');
